          ...
          <div className="mx-auto w-full max-w-[960px] px-6 py-[120px] min-h-screen flex items-center justify-center">
            <div className="max-w-[560px] text-center">
              ...
              <div className="space-y-4 text-sm leading-6 text-gray-600 md:text-base md:leading-7">
                ...
                <div>
                  SPDSは英語を「覚える」ための学習ではなく、英語が「立ち上がる」状態を鍛えるトレーニングです。すなわち、フレーズの記憶はあくまで通過点にすぎず、訓練によって強化されるのは、意味空間が与えられたときに即座に到達できる反射回路です。SPDSの特異な点は、反射の想起を記憶減衰モデルによってスケジューリングしつつ、動的な意味空間上のインスタンス（状況や文脈）生成により、入力文脈の分布をひいては反射回路の経路を拡張している点にあります。
                </div>
              </div>
            </div>
          </div>
